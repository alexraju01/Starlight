...
const MediaCard2 = ({ item, genreMap, mediaMode, style, isFirst, isLast }: Props) => {
	...
	const cardClasses = clsx(
		...
		{
			"absolute transform  group-hover:right-[calc(70vw-103%)] sm:group-hover:right-[calc(70vw-140%)] md:group-hover:right-[calc(70vw-250%)] lg:group-hover:right-[calc(70vw-312%)] xl:group-hover:right-[calc(70vw-432%)] 2xl:group-hover:right-[calc(70vw-420%)]":
