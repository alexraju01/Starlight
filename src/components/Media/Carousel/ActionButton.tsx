...
export default function ActionButtons() {
	return (
		<div className='relative w-full flex opacity-50 flex-row justify-start items-center gap-[13px] mb-9 sm:mb-[7px] md:mb-[47px]'>
			{/* Watch Trailer Button */}
			<div className='flex w-full sm:w-fit justify-center items-center relative group'>
