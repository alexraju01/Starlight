			...
			{uniqueGenres.map(({ id, name }) => {
				...
				return (
					<Link key={id} href={`/genre/${id}`}>
						<div className='flex flex-col items-center justify-center gap-4 rounded-xl bg-[#11223b] p-4 text-center text-lg outline outline-1 outline-white/20 transition-transform duration-300 ease-in-out hover:scale-110 h-36 sm:h-40 md:h-44 xl:h-48'>
